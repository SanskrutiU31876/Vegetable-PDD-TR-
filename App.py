...
def detect_disease(model, class_names):
    if uploaded_file is not None:
        ...
        if predicted_class == "Potato___Early_blight":
            ...
            # Add recommendations for Potato Early Blight
            ...
            st.write("Recommendations:")
            # Add recommendations for Potato Late Blight
            ...
            st.write("Recommendations:")
            # Add general recommendations for healthy potato plants
        ...
        # Similarly, add conditions for other classes
